...
{
    public class RecentTaskByMeAdapter : MvxRecyclerAdapter
    {
        private readonly TaskViewModel viewModel;

        public RecentTaskByMeAdapter(TaskViewModel viewModel, IMvxAndroidBindingContext bindingContext)
           : base(bindingContext)
        {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            var view = itemBindingContext.BindingInflate(Resource.Layout.item_recentTaskByMe, parent, false);
