...
namespace IPUnifiedComm.Droid.Adapters
{
    ...
    {
        private readonly CreateMessageViewModel viewModel;

        public event EventHandler<Contact> OnItemClick;

        public ContactsAdapter(CreateMessageViewModel viewModel, IMvxAndroidBindingContext bindingContext)
           : base(bindingContext)
        {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            var view = itemBindingContext.BindingInflate(Resource.Layout.item_contact, parent, false);
